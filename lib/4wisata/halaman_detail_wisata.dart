...
class DetailWisata extends StatefulWidget {
  final TourModal list_tour;
  DetailWisata(this.list_tour);
  @override
                                ...
                                child: ClipRRect(
                                  ...
                                  children: <Widget>[
                                    CachedNetworkImage(
                                      ...
                                      AspectRatio(
                                              aspectRatio: 16 / 9,child: buildSkeletonList(context)),
                        ...
                        child: Padding(
                          ...
                          child: Column(
                            ...
                            children: <Widget>[
                              ...
                              widget.list_tour.location == ""
                                  ? Container()
                                  : RaisedButton.icon(
                                      onPressed: () {
                                        launchURL(widget.list_tour.location);
                                      },
                                      icon: Icon(
                                        LineIcons.mapMarked,
                                        color: Colors.black87,
                              ...
                              widget.list_tour.youtube == "" &&
                                      widget.list_tour.instagram == "" &&
                                      widget.list_tour.facebook == ""
                                  ? Container()
                                  : SelectableText(
                                      'Media Sosial',
                                      style: GoogleFonts.inter(
